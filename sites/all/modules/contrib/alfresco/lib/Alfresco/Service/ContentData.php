...
class AlfContentData extends AlfBaseObject {
  ...
  public function onBeforeSave(&$statements, $where) {
    print "++ ContentData::onBeforeSave()\n";
    print "   _property= " . $this->_property . "\n";
    if ($this->_isDirty == true) {
      print "   I am DIRRRRTY\n";
      ...
      if ($this->_newFileContent != null) {
        ...
        $contentData = alf_upload_file($this->node->session, $this->_newFileContent, $this->_mimetype, $this->_encoding);
        ...
        $this->addStatement($statements, "writeContent", array(
